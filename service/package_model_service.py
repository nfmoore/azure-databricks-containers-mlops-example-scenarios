...
def parse_args(argv):
    ...
    ap.add_argument("--mlflow-model-artifiact-path", required=True)
...
def main():
    ...
    # Load MLFlow model
    mlflow_loaded_model = mlflow.xgboost.load_model(
        args.mlflow_model_artifiact_path)

    # Create service instance
    model_service = WineQualityService()

    # Package model artifact
    model_service.pack('model', mlflow_loaded_model)
